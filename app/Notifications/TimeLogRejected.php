...
final class TimeLogRejected extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    private function messageFormatter(): string
    {
        ...
        return sprintf(
            'Your time log for %s on %s with duration %s hours has been rejected by %s%s.',
