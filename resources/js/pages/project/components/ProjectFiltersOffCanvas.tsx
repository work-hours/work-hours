...
import ProjectFiltersComponent, { type ProjectFilters } from '@/pages/project/components/ProjectFilters'
import { SlidersHorizontal } from 'lucide-react'

interface ProjectFiltersOffCanvasProps {
    open: boolean
            ...
            <SheetContent side="right" className="overflow-y-auto bg-white pr-6 pb-8 pl-6 sm:max-w-md md:max-w-lg dark:bg-neutral-900">
                <SheetHeader className="">
                    ...
                    <SheetDescription className="text-sm text-neutral-500 dark:text-neutral-400">
                        Narrow down projects by date range, client, team member, or search.
                    </SheetDescription>
                </SheetHeader>
