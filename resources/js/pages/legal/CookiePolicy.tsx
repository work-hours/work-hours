...
export default function CookiePolicy() {
    return (
        <div className="min-h-screen bg-gradient-to-b from-background to-background/90">
            <Head title="Cookie Policy - Work Hours" />
            <Navbar />

            <main className="container mx-auto px-6 py-12 lg:px-8">
                <h1 className="mb-8 text-3xl font-bold tracking-tight text-foreground md:text-4xl">Cookie Policy</h1>
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground">
                    ...
                    <ul>
                        ...
                        <li>Advertising cookies. These cookies collect information about your visit to our website, the content you viewed, the links you followed and information about your browser, device, and your IP address.</li>
                    </ul>
                    ...
                    <h2>Contact Us</h2>
                    <p>
                        If you have any questions about our Cookie Policy, please contact us at cookies@workhours.com.
                    </p>
                </div>
            </main>
