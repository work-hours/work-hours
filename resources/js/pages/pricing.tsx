            ...
            <div className="space-y-6">
                ...
                <div className="rounded-lg border border-green-200 bg-green-50 p-4 dark:border-green-900/30 dark:bg-green-900/10">
                    <p className="text-gray-800 dark:text-gray-200">
                        There is <span className="font-semibold">no paywall</span> on any of the available features right now. You can use everything for
                ...
                <p className="text-gray-700 dark:text-gray-300">
                    ...
                    under no circumstances will we charge you without prior notice. We value transparency and will always keep you informed about any changes to our pricing model.
                </p>
            </div>
        </FeatureLayout>
    )
