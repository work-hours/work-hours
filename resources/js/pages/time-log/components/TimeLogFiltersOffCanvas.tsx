...
export default function TimeLogFiltersOffCanvas({ open, onOpenChange, filters, projects, tags }: TimeLogFiltersOffCanvasProps) {
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="overflow-y-auto bg-white pr-6 pb-8 pl-6 sm:max-w-md md:max-w-lg dark:bg-neutral-900">
        ...
        <div className="bg-white dark:border-neutral-800 dark:bg-neutral-800/30">
          <TimeLogFiltersForm filters={filters} projects={projects} tags={tags} />
        </div>
      </SheetContent>
    </Sheet>
  )
