...
interface TimeLogDeleteActionProps {
    timeLogId: number
    onDeleteSuccess?: () => void
}

export default function TimeLogDeleteAction({ timeLogId, onDeleteSuccess }: TimeLogDeleteActionProps) {
    ...
    const deleteTimeLog: FormEventHandler = (e) => {
        ...
        router.delete(route('time-log.destroy', timeLogId), {
            preserveScroll: true,
            onSuccess: () => {
