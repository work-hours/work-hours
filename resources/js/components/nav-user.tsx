                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            ...
                            <Icon iconNode={ChevronsUpDown} className="ml-auto size-4 text-neutral-600 transition-colors duration-200 group-hover:text-neutral-800 dark:text-neutral-400 dark:group-hover:text-neutral-200" />
                        </SidebarMenuButton>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent
