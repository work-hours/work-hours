    ...
    return (
        <section id="how-it-works" className="relative container mx-auto mb-24 px-6 lg:px-8" aria-label="How to use Work Hours">
            ...
            <div className="mb-16 text-center">
                <div className="relative mx-auto mb-6 w-fit">
                    <div className="border-b-2 border-gray-800/70 dark:border-gray-200/70 px-8 py-2">
                        <span className="font-['Courier_New',monospace] font-bold tracking-widest text-gray-800 dark:text-gray-200 uppercase">Instructions</span>
                    </div>
                ...
                <h2 className="mb-4 font-['Courier_New',monospace] text-3xl font-bold tracking-tight text-gray-800 dark:text-gray-200 uppercase md:text-5xl">
                    How It Works
                </h2>
            ...
            <div className="relative">
                ...
                <div
                    className="absolute top-24 left-1/2 hidden h-[calc(100%-120px)] w-0 -translate-x-1/2 border-l-2 border-dashed border-gray-400/50 dark:border-gray-500/50 lg:block"
                    aria-hidden="true"
                ></div>

                {/* Connecting lines for tablet - dotted line like a form */}
                <div
                    className="absolute top-24 left-1/2 hidden h-[calc(100%-120px)] w-0 -translate-x-1/2 border-l-2 border-dashed border-gray-400/50 dark:border-gray-500/50 md:block lg:hidden"
                    aria-hidden="true"
                ></div>
                ...
                <ol className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
                    <li className="group relative flex flex-col items-center text-center">
                        <div
                            className="mb-6 flex h-16 w-16 items-center justify-center border-2 border-gray-700 dark:border-gray-400 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200"
                            aria-hidden="true"
                        >
                        ...
                        <h3 className="mb-3 font-['Courier_New',monospace] text-xl font-bold text-gray-800 dark:text-gray-200 uppercase">Create Your Account</h3>
                    ...
                    <li className="group relative flex flex-col items-center text-center">
                        ...
                        <h3 className="mb-3 font-['Courier_New',monospace] text-xl font-bold text-gray-800 dark:text-gray-200 uppercase">Set Up Your Projects</h3>
                        <p className="font-['Courier_New',monospace] text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <li className="group relative flex flex-col items-center text-center">
                        ...
                        <h3 className="mb-3 font-['Courier_New',monospace] text-xl font-bold text-gray-800 dark:text-gray-200 uppercase">Build Your Team</h3>
                        <p className="font-['Courier_New',monospace] text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <li className="group relative flex flex-col items-center text-center">
                        ...
                        <h3 className="mb-3 font-['Courier_New',monospace] text-xl font-bold text-gray-800 dark:text-gray-200 uppercase">Start Tracking Time</h3>
                        <p className="font-['Courier_New',monospace] text-sm text-gray-700 dark:text-gray-300">
            ...
            <div className="mt-16 flex justify-center">
                <div className="relative border-2 border-gray-400 dark:border-gray-600 bg-yellow-50/50 dark:bg-yellow-900/20 px-6 py-3 text-center" role="note">
                    {/* Rubber stamp effect */}
                    <div className="absolute -top-3 -right-3 rotate-12">
                        <div className="border-2 border-red-800/40 dark:border-red-400/40 bg-white dark:bg-gray-800 px-2 py-0.5">
                            <span className="text-xs font-bold tracking-wider text-red-800/70 dark:text-red-400/90 uppercase">Note</span>
                        </div>
                    </div>
