    ...
    return (
        <section id="how-it-works" className="container mx-auto mb-24 px-6 lg:px-8">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                <div className="animate-fade-up animate-once animate-delay-500 flex flex-col items-center text-center">
                    <div className="animate-bounce-slow mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary text-white">
                ...
                <div className="animate-fade-up animate-once animate-delay-700 flex flex-col items-center text-center">
                    <div className="animate-bounce-slow mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary text-white [animation-delay:200ms]">
                ...
                <div className="animate-fade-up animate-once animate-delay-900 flex flex-col items-center text-center">
                    <div className="animate-bounce-slow mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary text-white [animation-delay:400ms]">
                ...
                <div className="animate-fade-up animate-once animate-delay-[1100ms] flex flex-col items-center text-center">
                    <div className="animate-bounce-slow mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary text-white [animation-delay:600ms]">
            ...
            <div className="mt-16 flex justify-center">
                <div className="animate-fade-up animate-once animate-delay-[1300ms] flex items-center gap-2 rounded-full bg-primary/10 px-6 py-3 transition-transform hover:scale-105">
