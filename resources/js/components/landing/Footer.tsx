                ...
                <div className="grid gap-10 md:grid-cols-3">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex space-x-4">
                            <a href="#" className="rounded-full p-2 text-neutral-500 transition-colors duration-200 hover:bg-neutral-100 hover:text-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-800 dark:hover:text-neutral-300">
                    ...
                    {/* Company Links */}
                    <div>
                        <h3 className="mb-6 text-sm font-semibold uppercase text-neutral-800 dark:text-neutral-200">
                            Company
                        </h3>
