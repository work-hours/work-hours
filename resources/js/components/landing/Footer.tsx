...
export default function Footer() {
    return (
        <footer className="w-full border-t border-gray-200 bg-white py-16 dark:border-gray-800 dark:bg-gray-800">
                ...
                <div className="grid gap-10 md:grid-cols-3">
                    ...
                    <div className="flex flex-col">
                        <div className="mb-4 flex items-center gap-2">
                            ...
                            <span className="-ml-4 text-lg font-bold tracking-wide text-gray-900 dark:text-white">Work Hours</span>
                        </div>
                        <p className="mb-6 text-gray-600 dark:text-gray-300">
                            Simplifying time tracking for teams and individuals since 2025.
                        </p>
                        <div className="flex space-x-4">
                            <a href="#" className="rounded-full p-2 text-gray-500 transition-colors hover:bg-gray-100 hover:text-blue-600 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-blue-400">
