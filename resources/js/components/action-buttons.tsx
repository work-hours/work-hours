...
const variantStyles = {
    ...
    emerald: 'border-emerald-200 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 dark:border-emerald-700 dark:bg-emerald-900/20 dark:hover:bg-emerald-900/30 dark:text-emerald-300',
    ...
    return (
        <a href={href} className="inline-block">
            <Button
                variant="outline"
                size="sm"
                className={`flex items-center gap-2 h-8 ${variantStyles.emerald} transition-all shadow-sm ${className}`}
            >
