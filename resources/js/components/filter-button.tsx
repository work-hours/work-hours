...
export default function FilterButton({ className, children, variant = 'apply', type, ...props }: FilterButtonProps) {
    ...
    return (
        <Button type={type ?? defaultType} className={cn(base, variantClass, className)} {...props}>
            {children}
        </Button>
    )
}
